<template>
  <header class="w-full h-16 backdrop-blur-lg bg-white/80 border-b border-gray-200/60 flex items-center px-8 sticky top-0 z-50 shadow-sm">
    ...
    <nav class="hidden md:flex gap-10 ml-auto relative items-center">
      <button
        ...
        <span
          ...
          class="absolute left-0 bottom-0 w-full h-[2px] bg-indigo-600 rounded-full animate-slideIn"></span>
      </button>
    </nav>
